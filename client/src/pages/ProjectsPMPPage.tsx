...
export default function ProjectsPMPPage() {
  ...
  return (
    <main className="projects-shell" dir="rtl">
      <style>{styles}</style>
      <header className="hero-card"><a className="back" href="/">← الرئيسية</a><a className="agents" href="/projects">النسخة الحالية</a><span className="eyebrow">PMP MODE</span><h1>مشاريع PMP</h1><p>نسخة مفككة وآمنة لربط مراحل المشروع بنموذج PMP الفعلي.</p></header>
